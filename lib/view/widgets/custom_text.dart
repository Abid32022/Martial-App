...
Widget customTextRegular({required String title,double height = 1,double latterSpacing = 0.7 ,TextOverflow? overflow,int maxlines = 6,Color color = Colors.black,TextAlign textAlign =TextAlign.start, double fontSize = 12, FontWeight fontWeight = FontWeight.normal,TextAlign align = TextAlign.start}){
  return Text(title,style: TextStyle(
    fontSize: fontSize,
    fontFamily: 'EnnVisions',
