              ...
              colors: AppColors.Secondary,
                ...
                borderRadius: 8.87.r,
                 ...
                 authcustombottomsheet(
                  ...
                  context,
                  text1: 'Successful',
                  text2: 'We appreciate your report regarding the issue you encountered in our app. Your feedback is highly valuable to us, and we are committed to resolving this problem to enhance your overall experience.'
                  );
                  }
              ),
          ],
         ...
         child: Column(
          ...
          children: [
            ...
            SizedBox(height: 30.h,),
             customTextRegular(title: 'Feature',fontSize: 15.h,fontWeight: FontWeight.w500),
                SizedBox(height: 8.h,),
                  Container(
                        ...
                        expandedCrossAxisAlignment: CrossAxisAlignment.start,
                         ...
                         child: Icon(isicon ? Icons.keyboard_arrow_up_rounded : Icons.keyboard_arrow_down_rounded, color: AppColors.darkgrey,)),
                          ...
                          title: customTextBold(title: selectedtopic.isNotEmpty ? selectedtopic : "Select Topic", fontWeight: FontWeight.w500, fontSize: 15.h,color: AppColors.darkgrey),
                          children: <Widget>  [
                           ...List.generate(
                            selecttopic.length,
                            (i) => InkWell(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    SizedBox(width: 10.w,),
                                    customTextBold(title: selecttopic[i], fontWeight: FontWeight.w400, fontSize: 15.h,color: AppColors.darkgrey),
                                  ],
                                )),
                            ),
                           ),
            ...
            SizedBox(height: 20.h,),
            customTextRegular(title: 'ScreenShoot',fontSize: 15.h,fontWeight: FontWeight.w500),
                SizedBox(height: 8.h,),
                customTextField(
                ...
                SizedBox(height: 20.h,),
               customTextRegular(title: 'Explain issue',fontSize: 15.h,fontWeight: FontWeight.w500),
                SizedBox(height: 8.h,),
                SizedBox(
                  height: 190.h,
                  child: customTextField(
                    maxLines: 7,
                    // bordercolor: Colors.red,
                      hintText: "Please share your feedback message",
                  ),
                ),
          ],
         ),
